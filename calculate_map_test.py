...
parser.add_argument('--predicted_file', default=HOME + '/work/eval/', type=str, help='Checkpoint state_dict file for transfer learning')
args = parser.parse_args()

annopath = os.path.join(HOME + '/work/Anno_test/', '%s.xml')#测试集标注文件路径
test_imagesetfile = HOME + '/work/core_coreless_test.txt'#测试集里面的图片名
'''
